...
| 2026-09-04 | Hapus Heatmap | Hapus Heatmap Waktu dari monthly_report_screen + helper heatmap di analysis_provider (~148 baris) | ✅ Done |
| 2026-09-04 | Search Keyboard Fix | Sembunyikan FAB+navbar saat keyboard terbuka (main_screen), hapus Scaffold ganda HomeScreen, padding list dinamis 100→20, auto-scroll ke search bar, hapus bounce easeOutBack di SimpleFab | ✅ Done |
| 2026-09-04 | Search Clear Button | Tambah TextEditingController di search bar; tombol silang clear teks + reset filter provider + tutup keyboard (unfocus) | ✅ Done |
| 2026-09-04 | Search Scroll Fix | Ganti hardcoded animateTo(200) dengan Scrollable.ensureVisible via GlobalKey + spacer dinamis setinggi keyboard + koreksi offset header sticky 124px; atasi maxScrollExtent=0 saat item sedikit | ✅ Done |
| 2026-09-04 | Search Glitch Fix | Hapus listener manual + jumpTo penyebab glitch; ganti dengan scrollPadding bawaan TextField (top 130, bottom 20) — 1 transisi mulus sinkron dengan keyboard | ✅ Done |
| 2026-09-04 | Search Auto-Center | Kembalikan auto-center via 1 animateTo presisi: getOffsetToReveal - header sticky 116px, tanpa jumpTo/animasi ganda; GlobalKey + import rendering | ✅ Done |
| 2026-09-04 | Category Detail Sheet | Opsi B: CategoryDetailBottomSheet (header + budget progress + statistik + full list transaksi); tap baris kategori income/expense buka sheet; hapus expand inline take(5) + _expandedCategories | ✅ Done |
| 2026-09-04 | Category Sheet Revamp | Desain ulang bottom sheet: hero card gradien + badge %, kartu anggaran + badge status, kartu statistik ikon, tile transaksi + badge tanggal, empty state, animasi staggered; betulkan tipe FaIconData | ✅ Done |
| 2026-09-04 | Monthly Tab Revamp | Restruktur tab Bulanan: header + MonthPicker, segmented Pengeluaran/Pemasukan, hero arus kas (pemasukan/pengeluaran/net + badge Surplus/Defisit), kartu donut + pill kategori terbesar, baris kategori jadi kartu individual + caption %, empty state card; hapus _buildTypeToggle | ✅ Done |
| 2026-09-04 | Month Picker Revamp | Desain ulang bottom sheet periode: header + badge tahun, 3 pintasan (Bulan Ini/Lalu/Semua), grid 4x3 dengan penanda titik bulan berjalan + selected glow; tombol pemicu polished | ✅ Done |
| 2026-09-04 | Yearly Tab Revamp | Year picker + tombol Tahun Ini, YoY card dengan badge tren bermakna, dual-bar rounded + legenda pill, cashflow SplineArea gradien, stat card border + badge subtitle, riwayat bulanan jadi kartu + pill Surplus/Defisit; hapus _legendDot tak terpakai | ✅ Done |
| 2026-09-04 | Legend Overflow Fix | Ganti Row legenda grafik tahunan & arus kas jadi Wrap (spacing 8, runSpacing 6), rampingkan padding _legendPill 10/5 → 8/4; atasi RenderFlex overflow 1.3px | ✅ Done |
| 2026-09-04 | Detail Screen Revamp | Judul + tahun dinamis, hero arus kas putih + badge Surplus/Defisit, weekly chart pill Wrap + bar rounded-8, top list tile badge tanggal, segmented kategori, kategori jadi kartu tap-to-sheet, animasi staggered | ✅ Done |
...
| 2026-09-04 | Tambah/Edit Revamp | Widget baru TransactionModeSegment + AmountHeroInput (pill +10rb-100rb, reset); preFilledNote + wire OCR; tanggal dd MMM yyyy; savings piggy icon; tombol simpan berikon; hapus TransactionTypeToggle | ✅ Done |
