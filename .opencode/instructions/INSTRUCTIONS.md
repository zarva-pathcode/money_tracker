...
### After Writing/Editing Code (Flutter/Dart)
- Run `dart format .` to format Dart files
- Run `dart analyze` to check for Dart errors
- Run `flutter test` to run tests
- Check for `print()` / `debugPrint()` statements and remove them

### Before Committing
- Run security checks manually
- Verify no secrets in code
- Run full test suite: `flutter test`
- Run `dart analyze` to ensure no warnings
